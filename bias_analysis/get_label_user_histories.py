...
mw_hist = mw_hist.select(["revision_id","event_timestamp","event_user_id","wiki_db"])
...
gb = gb.withColumn("time_since_first_edit_s", f.unix_timestamp(f.col("time_last_edit")) - f.unix_timestamp(f.col("time_first_edit")))
